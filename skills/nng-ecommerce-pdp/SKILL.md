---
name: nng-ecommerce-pdp
description: Directrices rigurosas de experiencia de usuario (UX) e investigación empírica de Nielsen Norman Group (NN/g) para páginas de detalle de producto (PDP) en ecommerce. Usar al diseñar, auditar o implementar layouts de PDP, jerarquía visual, resolución de preguntas frecuentes mediante copy e imágenes, consistencia en comparativas, sistema de reviews con metadatos, y feedback de adición al carrito.
---

# Directrices UX de Nielsen Norman Group para Páginas de Producto (PDP)

Guía y marco metodológico basado en la investigación empírica de **Nielsen Norman Group (NN/g)** (*11 UX Guidelines for Ecommerce Product Pages*, por Katie Sherwin, estudio sobre 49 sitios de comercio electrónico).

La premisa central de NN/g: **En ecommerce, los compradores no pueden tocar el producto, hablar con un vendedor ni probarlo antes de comprar.** La PDP debe responder todas las preguntas con la menor fricción posible. Una PDP deficiente produce dos fallas críticas:
...
NN/g categoriza los elementos de una página de producto en tres niveles indispensables:
...
```
              ...
              /-------\   *Solo si la ejecución es perfecta*
             /         \
...
- **Nombre de producto descriptivo**: claro, sin jerga críptica interna.
- **Imagen reconocible y fidedigna**: representativa del artículo real.
- **Vista ampliada de alta resolución**: capacidad de ver detalles y acabados.
...
### Nivel 2: Nice-to-Have (Esperados por el usuario moderno)
...
- **Recomendaciones de productos asociados o complementarios**: altamente pertinentes (*Cross-selling*).
- **Herramientas de Wishlist o lista de deseos**.

### Nivel 3: Fancy Features (Opcionales de alto impacto — Exigen ejecución impecable)
> [!WARNING]
> Si estas funciones tienen fallas, lentitud o alta fricción, generan frustración y dañan la credibilidad del sitio. Solo deben incluirse si aportan utilidad real y operan con fluidez técnica absoluta.
- Visualizadores 3D en tiempo real y configuradores interactivos (*Mix & Match*).
- Fotos y videos subidos directamente por compradores en las reviews.
- Filtros avanzados y metadatos en las opiniones (ej. edad del usuario, dimensiones del espacio, uso dado).
...
2. **Aclarar terminología especializada de inmediato**: Si se emplea un término comercial o técnico de la marca (ej. *"Mármol sintético Gelcoat"*, *"Madera RH"*, *"Cartucho cerámico 35mm"*), debe existir un micro-tooltip o aclaración explícita de qué significa para el cliente (ej. *"Resistente 100% a la humedad, no se hincha"*).
...
| Nivel | Principio UX de NN/g | Implementación Recomendada |
| :--- | :--- | :--- |
...
| **2. Dentro de la Categoría** | Ficha técnica y atributos comparables | Todas las tinas o lavamanos deben listar en el mismo orden: Largo × Ancho × Profundidad, Peso, Capacidad en Litros y Diámetro de Desagüe. Usar tablas de especificaciones estandarizadas. |
...
- Los usuarios van deliberadamente a buscar las **reseñas negativas** para evaluar el riesgo real del producto. Si un sitio oculta las opiniones críticas o solo muestra 5 estrellas, pierde credibilidad instantáneamente.
